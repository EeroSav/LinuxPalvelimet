...
Tein myös oppitunnilla git.sh bash skriptin jos päivittelen tätä repositorya enkä jaksa kirjoittaa committien viestejä, skripti löytyy juurihakemistosta:
